...
local function delete_world_formspec(dialogdata)
	return formspec_wrapper([[
		...
		button[0,1;10,1;message;${msg}]
		${common_styling}

		style[world_delete_confirm;bgcolor=#ff3333]
		button[1.5,3;2.5,0.8;world_delete_confirm;${txt_delete}]
		button[6,3;2.5,0.8;world_delete_cancel;${txt_cancel}]
	]], {
		common_styling = kl_formspec_styling(),
		msg = fgettext("Delete World \"$1\"?", dialogdata.delete_name),
