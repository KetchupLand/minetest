...
const std::string Discord::s_application_id = "898987029294096484";
...
struct DataRichPresence
{
	...
	std::string large_image_key = "ketchupland";
	std::string large_image_text = "KetchupLand";
	std::string small_image_key = "kl_items_tomato";
	std::string small_image_text = "tomato tomato";
	std::string party_id = "";
